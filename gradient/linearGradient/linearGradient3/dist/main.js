...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Random\": () => (/* binding */ Random)\n/* harmony export */ });\nclass Random {\r\n}\r\n/**\r\n *\r\n * @param min\r\n * @param max\r\n * @returns Math.random() * (max - min) + min\r\n */\r\nRandom.random = (min, max) => {\r\n    return Math.random() * (max - min) + min;\r\n};\r\n\n\n//# sourceURL=webpack://linear_gradient3/./src/draw/mathematics/random.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"PrototypeGradsRect\": () => (/* reexport safe */ _prototype_rect_grads__WEBPACK_IMPORTED_MODULE_0__.PrototypeGradsRect),\n/* harmony export */   \"BaseGradsRect\": () => (/* reexport safe */ _basic_grads_rect__WEBPACK_IMPORTED_MODULE_1__.BaseGradsRect),\n/* harmony export */   \"GradsRect\": () => (/* reexport safe */ _grads_rect__WEBPACK_IMPORTED_MODULE_2__.GradsRect)\n/* harmony export */ });\n/* harmony import */ var _prototype_rect_grads__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prototype_rect_grads */ \"./src/gradient_rectangle/prototype_rect_grads.ts\");\n/* harmony import */ var _basic_grads_rect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./basic_grads_rect */ \"./src/gradient_rectangle/basic_grads_rect.ts\");\n/* harmony import */ var _grads_rect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./grads_rect */ \"./src/gradient_rectangle/grads_rect.ts\");\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://linear_gradient3/./src/gradient_rectangle/gradients.ts?");

/***/ }),

/***/ "./src/gradient_rectangle/grads_rect.ts":
/*!**********************************************!*\
  !*** ./src/gradient_rectangle/grads_rect.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"GradsRect\": () => (/* binding */ GradsRect)\n/* harmony export */ });\n/* harmony import */ var _draw_draw__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../draw/draw */ \"./src/draw/draw.ts\");\n\r\n/**\r\n * グラデションの間隔を細かく指定できるようになった\r\n */\r\nclass GradsRect {\r\n    /**\r\n     *\r\n     * @param gl\r\n     */\r\n    constructor(gl) {\r\n        this.setupGradation = (canvasSize) => {\r\n            [...Array(this.rectMax).keys()].forEach((count) => {\r\n                const initPosition = new _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Vector2(_draw_draw__WEBPACK_IMPORTED_MODULE_0__.Random.random(0, canvasSize.x), _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Random.random(0, canvasSize.y));\r\n                const initSize = _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Random.random(100, 256);\r\n                this.position.push(initPosition);\r\n                this.size.push(initSize);\r\n            });\r\n        };\r\n        this.drawGradation = () => {\r\n            if (this.gradationColorData.length !== this.gradationStep.length) {\r\n                throw new Error(\"グラデーションステップ数と色データの個数が一致しません😖\");\r\n            }\r\n            this.gl.save();\r\n            this.gl.filter = \"blur(4px)\";\r\n            [...Array(this.rectMax).keys()].forEach((count) => {\r\n                this.gl.beginPath();\r\n                const init_size = this.size[count];\r\n                const draw_size = new _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Vector2(init_size, init_size);\r\n                const basePosition = this.position[count];\r\n                const draw_position = new _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Vector2(basePosition.x, basePosition.y);\r\n                const colorGradient1 = this.gl.createLinearGradient(draw_position.x + draw_size.x / 2.0, draw_position.y, draw_position.x + draw_size.x / 2.0, draw_position.y + draw_size.y);\r\n                [...Array(this.gradationStep.length).keys()].forEach((color_count) => {\r\n                    colorGradient1.addColorStop(this.gradationStep[color_count], this.gradationColorData[color_count]);\r\n                });\r\n                const rect = new _draw_draw__WEBPACK_IMPORTED_MODULE_0__.Rectangle(this.gl, draw_position, draw_size);\r\n                rect.draw_fill(colorGradient1);\r\n                this.gl.closePath();\r\n            });\r\n            this.gl.restore();\r\n        };\r\n        this.gl = gl;\r\n        this.rectMax = 100;\r\n        this.position = [];\r\n        this.size = [];\r\n        this.gradationStep = [0.0, 0.25, 0.5, 0.75, 1.0];\r\n        this.gradationColorData = [\r\n            \"rgba(10, 50, 50, 1.0)\",\r\n            \"rgba(10, 150, 150, 1.0)\",\r\n            \"rgba(10, 250, 250, 1.0)\",\r\n            \"rgba(10, 150, 150, 1.0)\",\r\n            \"rgba(10, 50, 50, 1.0)\",\r\n        ];\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://linear_gradient3/./src/gradient_rectangle/grads_rect.ts?");

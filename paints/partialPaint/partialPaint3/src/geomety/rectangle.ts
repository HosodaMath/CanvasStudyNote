...
class Rectangle {
   ...
   * @param {number} alpha 
   */
  draw = (fill: string | CanvasGradient, stroke: string | CanvasGradient, stroke_weight: number = 1.0, alpha: number = 1.0) => {
   ...
   * @param alpha 
   */
  draw_stroke = (stroke: string | CanvasGradient, stroke_weight: number = 1.0, alpha: number = 1.0) => {
    this.gl.globalAlpha = alpha;
    this.gl.strokeStyle = stroke;
    this.gl.lineWidth = stroke_weight;
    this.gl.beginPath();
